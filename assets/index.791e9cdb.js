import{d,s as c,y as r,r as p}from"./router.698b93dc.js";import{m,c as h}from"./index.5f430525.js";import{l as g}from"./localized-decorator.3e035a57.js";import"./index.82f7b823.js";const w=`@media screen and (max-width: 1439px){.desktop-only{display:none!important}}.small-only{display:none!important}@media screen and (max-width: 1023px){.small-only{display:flex!important}}@media screen and (max-width: 1023px){.hide-on-small{display:none!important}}.wrapper{height:var(--navigation-height);padding-left:24px;padding-right:24px}.contact-icon{width:24px;height:24px}@media screen and (max-width: 1023px){.wrapper{padding:18px}}@media screen and (max-width: 428px){.contacts{justify-content:flex-start!important;flex-wrap:wrap}#email{margin-top:12px;flex-basis:100%}}
